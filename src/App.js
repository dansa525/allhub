...
function AdBanner() {
  ...
  return (
    <div style={{marginTop:16, marginBottom:2, borderRadius:14, overflow:"hidden",
  ...
  return (
    <div style={{
      ...
      <main style={{maxWidth:1100, margin:"0 auto", padding:"9px 16px 6px"}}>
        ...
        <div style={{display:"grid", gridTemplateColumns:"1fr 1fr", gap:6, marginTop:14, marginBottom:0}}>
          {[
